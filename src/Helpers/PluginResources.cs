namespace Loupedeck.NotifyBuzzPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.NotifyBuzzPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.NotifyBuzzPlugin.Resources.Resource.txt`.
